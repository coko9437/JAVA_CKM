...
public class Basic_Ex1 {
    // 자바에서 제공하는 JDK 주요패키지 (폴더:기능(클래스) 모아 둔)
    // java.lang : String, Object, Math 등 기본 클래스 제공.
    // java.util : 날짜, 컬렉션, Scanner 등 유틸리티 제공.

    // Object : 간단히 언급 모든 클래스는 암묵적으로 Object 상속 하고있다.
    // 상속은 받지만 Object기능을 사용안하고 재정의해서 사용함.
    // Object 주요 메서드
    ...
    // Wrapper 클래스 : 기본형타입 -> 참조형 타입으로 변경하는 클래스
    // 예시) int타입 --> Integer 형 변경 , 또는 문자열"123" --> 숫자형으로 변경하거나
