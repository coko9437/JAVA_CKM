...
// [변경1] 기존배열 -> 컬렉션으로 변경
    ...
    // private static ArrayList<Member> members = new ArrayList<>();
        // --> 변경) HashMap 1, ArrayList -> HashMap형태로 변경
...
// [변경2]   
            ...
            //후
            // members.add(member);
                // --> 변경) HashMap 2, ArrayList -> HashMap형태로 변경
...
// [변경3] 기존 배열에서 -> 컬렉션으로 수정.
        ...
        // }
            // --> 변경) HashMap 3, ArrayList -> HashMap형태로 변경
        // members.entrySet() -> 기능을 사용하면 
            // 키(key)와 값(value)를 가지는 하나의 테이블 정보를 제공해줌.
...
// [변경4] 기존 member(0x100)에서, 변경할 내용으로 수정이 된 새로운 member(0x200) 로 교체 작업
        ...
        //-------------------------------
        // 후
        // member.set(index, member);
            // --> 변경) HashMap 4, ArrayList -> HashMap형태로 변경
        members.put(index, member); // 여기서 index는 키 임<Integer>
...
// [변경5]
        ...
        // members.remove(index);
            // --> 변경) HashMap 5, ArrayList -> HashMap형태로 변경
        Member member = members.get(index);
            System.out.println("삭제할 회원 정보 : " );
                member.showInfo();
        members.remove(index); //사실 ArrayList랑 똑같음.
...
// [변경6]
                ...
                // members.add(dummyMember);
                    // --> 변경) HashMap 6, ArrayList -> HashMap형태로 변경
