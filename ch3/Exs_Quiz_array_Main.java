...
public class Exs_Quiz_array_Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("=================================================================");
            System.out.println("1. 도서 추가 , 2. 도서 조회, 3. 도서 수정, 4. 도서 삭제, 5. 더미 데이터7개 추가,  0. 종료");
            System.out.println("=================================================================");
            ...
            switch (menu) {
                case 1:
                    Exs_Quiz_array.addBook(scanner);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Exs_Quiz_array.deleteBook(scanner); 
                    break;
                case 5:
                    Exs_Quiz_array.addDummyBooks(); 
                    System.out.println("더미 데이터 7개가 추가되었습니다.");
                    break;
                case 0:
